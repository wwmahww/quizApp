...
exports.logout = exports.login = exports.hideValidate = exports.showValidate = exports.validate = void 0;
...
var logoutBtn = $('.logout-btn'); // VALUES

var showPass = 0; // DELEGATION
...
$('.validate-form').on('submit', function () {
  ...
  for (var i = 0; i < input.length; i++) {
    if ((0, _login.validate)(input[i]) == false) {
      (0, _login.showValidate)(input[i]);
      check = false;
    }
  }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "14617" + '/');
